 ...
 */
@Embeddable
public class TipoplantaPK implements Serializable {
    ...
    public TipoplantaPK(String nombrecientifico, String nombrecomun) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TipoplantaPK)) {
            return false;
        }
        TipoplantaPK other = (TipoplantaPK) object;
    ...
    public String toString() {
        return "grupo6.DP.entidades.TipoplantaPK[ nombrecientifico=" + nombrecientifico + ", nombrecomun=" + nombrecomun + " ]";
    }
